...
valid_state(bulb_off, switch_unpressed, socket_on, low_voltage, sensor_low).

% Rule 灯泡关闭的时候，没有按下开关，插座关闭，电压高，传感器高传感
valid_state(bulb_off, switch_unpressed, socket_off, high_voltage, sensor_low).
